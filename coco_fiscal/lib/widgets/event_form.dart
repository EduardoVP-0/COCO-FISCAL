...
class _EventFormState extends State<EventForm> {
  ...
  Future<void> guardarEvento() async {
    ...
    final url = Uri.parse(
      esEdicion
          ? "http://10.0.2.2:81/api_coco/update_event.php"
          : "http://10.0.2.2:81/api_coco/insert_event.php",
    );
        ...
        child: Column(
          ...
          children: [
            ...
            children: [
              SizedBox(width: 40),
            Text(
              widget.eventoExistente != null ? "Editar Evento" : "Nuevo Evento",
              style: TextStyle(
                fontSize: 20,
            ...
            IconButton(
                ...
                onPressed: () => Navigator.pop(context), // 👈 CIERRA EL FORMULARIO
              ),
            ],
          ),
            SizedBox(height: 16),
