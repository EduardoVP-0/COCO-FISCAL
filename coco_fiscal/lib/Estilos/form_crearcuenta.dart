...
class AppTextStyles {
  ...
  static const TextStyle labelCalle = TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w600,
    color: Color.fromARGB(255, 189, 191, 192), // <-- Color diferente
  );
}

// Labels y constantes
class AppLabels {
  static const String requiredIndicator = '①';
...
// Estilos para Dropdown (Combobox)
...
// En form_crearcuenta.dart - modifica esta parte:
      ...
      children: [
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Colonia ${AppLabels.requiredIndicator}',
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Número ${AppLabels.requiredIndicator}',
                style: AppTextStyles.labelCalle,
              ),
              const SizedBox(height: 8),
              TextField(
      ...
      children: [
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Código Postal ${AppLabels.requiredIndicator}',
                style: AppTextStyles.labelCalle,
              ),
              const SizedBox(height: 8),
              TextField(
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Ciudad ${AppLabels.requiredIndicator}',
                style: AppTextStyles.labelCalle,
              ),
              const SizedBox(height: 8),
      ...
      children: [
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Estado ${AppLabels.requiredIndicator}',
                style: AppTextStyles.labelCalle,
              ),
              const SizedBox(height: 8),
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
              Text(
                'País ${AppLabels.requiredIndicator}',
                style: AppTextStyles.labelCalle,
              ),
              const SizedBox(height: 8),
...
class _DatePickerFieldState extends State<DatePickerField> {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(widget.label, style: AppTextStyles.labelCalle),
        const SizedBox(height: 8),
        TextField(
          ...
          RichText(
            text: TextSpan(
              children: [
                ...
                const TextSpan(
                  text: ' ${AppLabels.requiredIndicator}',
                  style: TextStyle(fontSize: 16, color: Colors.black),
                ),
              ],
            ),
...
class _ProfileImagePickerState extends State<ProfileImagePicker> {
  ...
  Future<void> _pickImage() async {
    try {
      ...
      // Muestra un snackbar o diálogo de error al usuario
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Stack(
        ...
        children: [
          // Círculo con imagen o placeholder
          Container(
            width: 200,
            height: 200,
            decoration: BoxDecoration(
              ...
              border: Border.all(color: AppColors.inputBorderColor, width: 2),
            ),
          ),
                      ...
                      style: TextStyle(
                        ...
                        color: isSelected
                            ? AppColors
                                  .primaryColor // Cuando está seleccionada
                            : Colors
                                  .white, // Blanco para contraste cuando NO está seleccionada
                      ),
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isSelected
                        ? AppColors.primaryColor
                        : Colors
                              .white, // Borde blanco cuando NO está seleccionada
                    width: 2,
                  ),
                ),
                child: isSelected
  ...
  Widget build(BuildContext context) {
    return SeccionConTitulo(
      ...
      children: [
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CfdTextFieldBlanco(controller: claveController),
                ],
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height:
                        40, // ← CAMBIA ESTE VALOR PARA HACER MÁS PEQUEÑO (28, 26, etc.)
                    decoration: BoxDecoration(
        ...
        // Cantidad y Valor Unitario en misma fila - MISMO ANCHO QUE CLAVE
        Row(
          children: [
            // CANTIDAD - 50% DEL ANCHO
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
